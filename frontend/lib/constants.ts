 ...
 * WebSockets (real-time ingestion transport hasn't been decided;
 * polling is the simple interim choice for
 ...
 * (offset/limit, per the backend's pagination contract) stays
 ...
 * normal network latency". Long enough
 * that a normal warm request (well under 1s locally, well under this even
 * against the deployed Supabase-backed instance -- per measured
